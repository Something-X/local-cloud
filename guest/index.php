            ...
            <header class="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between flex-shrink-0">
                <div>
                    <nav class="flex items-center gap-2 text-sm">
                        <a href="index.php" class="text-slate-500 hover:text-blue-600 transition-colors flex items-center gap-1">
                            <i class="fas fa-home"></i>
                            <span>Home</span>
                        </a>
                        <?php foreach ($breadcrumbs as $bc): ?>
                        <i class="fas fa-chevron-right text-slate-300 text-xs"></i>
                        <a href="index.php?folder=<?= $bc['id'] ?>" class="text-slate-500 hover:text-blue-600 transition-colors">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <div id="gridView">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 mb-6">
                        ...
                        <a href="index.php?folder=<?= $folder['id'] ?>" class="file-card bg-white rounded-xl border border-slate-200 p-4 block group">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                        ...
                        <div class="file-card bg-white rounded-xl border border-slate-200 p-4 cursor-pointer group relative" onclick="previewFile(<?= $file['id'] ?>, '<?= htmlspecialchars($file['original_name'], ENT_QUOTES) ?>', '<?= $file['type'] ?>', '<?= $file['path'] ?>')">
                            ...
                            <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <a href="../download.php?id=<?= $file['id'] ?>" onclick="event.stopPropagation();" class="w-8 h-8 bg-blue-500 hover:bg-blue-600 rounded-lg flex items-center justify-center text-white shadow-lg" title="Download">
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-slate-100 hover:bg-blue-50/50 cursor-pointer transition-colors" onclick="previewFile(<?= $file['id'] ?>, '<?= htmlspecialchars($file['original_name'], ENT_QUOTES) ?>', '<?= $file['type'] ?>', '<?= $file['path'] ?>')">
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <a href="../download.php?id=<?= $file['id'] ?>" onclick="event.stopPropagation();" class="inline-flex items-center gap-1 text-blue-500 hover:text-blue-600 text-sm font-medium transition-colors">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] mx-4 overflow-hidden flex flex-col">
            <div class="flex items-center justify-between px-6 py-4 border-b border-slate-200 flex-shrink-0">
                ...
                <div class="flex items-center gap-2">
                    <a href="#" id="previewDownload" download="" class="px-4 py-2 text-sm font-medium bg-blue-600 hover:bg-blue-500 text-white rounded-xl transition-colors flex items-center gap-2">
